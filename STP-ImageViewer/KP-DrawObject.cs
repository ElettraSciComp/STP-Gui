        ...
        public void Draw(Graphics g)
        {
            ...
            try
            {
                    ...
                    if (this.bmp != null)
                    {
                        ...
                        Rectangle zRect = boundingRect;

                        int zX = (int)((this.panelWidth - boundingRect.Width) / 2.0 + 0.5);
                        if (zX < 0) zX = 0;
                        int zY = (int)((this.panelHeight - boundingRect.Height) / 2.0 + 0.5);
                        if (zY < 0) zY = 0;

                        zRect.Location = new Point(zRect.Location.X + zX, zRect.Location.Y + zY);

                        g.DrawImage(this.bmp, zRect);
                    }               
            }
            catch (Exception ex)
            {
