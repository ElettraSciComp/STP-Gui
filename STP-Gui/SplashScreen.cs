// Downloaded from http://www.codeproject.com/Articles/6511/Transparent-Splash-Screen
// The Code Project Open License (CPOL) 1.02 applies in this case.

// Further modifications by F. Brun
...
namespace SYRMEPTomoProject
{
    ...
    public partial class SplashScreen : PerPixelAlphaForm
	{
		...
		public SplashScreen()
		{
			...
			UpdateTimer.Start();
            SetBitmap(Properties.Resources.Splash);
            this.ClientSize = Properties.Resources.Splash.Size;                        
		}
